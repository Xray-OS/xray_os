...
#set -e
##################################################################################################################
# Author	:	Erik Dubois and used by Xray_OS
# Website	:	https://gitlab.com/Xray_OS --> Angel Gustavo Lopez Website
...
echo
	...
	#profiledef.sh
	oldname1='iso_name="xray_os'
	newname1='iso_name="xray_os'

	oldname2='iso_label="xray_os'
	newname2='iso_label="xray_os'
